...
| **ETL** | Pandas, Requests |
| **Cloud** | AWS Lambda, Amazon S3, EventBridge, IAM |
...
El dashboard se encuentra desplegado mediante **Streamlit Community Cloud** y consulta los datos procesados directamente desde Amazon S3.
